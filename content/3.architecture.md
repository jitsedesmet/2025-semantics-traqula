...
<pre style="overflow: auto"><code class="language-typescript" style="background: unset;">import type { SparqlRule } from '@traqula/core';
...
<pre style="overflow: auto"><code class="language-typescript" style="background: unset;">import { ParserBuilder } from '@traqula/core';
...
const ast = parser.iriOrNil(myString, myContext, myParameters)</code></pre>
<figcaption markdown="block">
