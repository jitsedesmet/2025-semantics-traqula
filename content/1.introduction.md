...
This opens the door to use cases such as heterogeneous query tooling (e.g., adapting editors like [YASGUI](https://yasgui.org/) to custom SPARQL dialects),
...
The next section discusses the state of the system architecture, while [](#demo) sketches the demonstration that we will provide to the workshop.
